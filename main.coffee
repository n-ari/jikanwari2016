...
main = ->
  vm = new Vue
    ...
    methods :
      JKE: ->
        @list = ["情報工学科200E","情報工学科300E","情報工学系200","情報工学系300","文系","第二外国語"]
        do update
      JKO: ->
        @list = ["情報工学科200O","情報工学科300O","情報工学系200","情報工学系300","文系","第二外国語"]
        do update
      JKEO: ->
        @list = ["情報工学科200EO","情報工学科300EO","情報工学系200","情報工学系300","文系","第二外国語"]
        do update
      update: ->
        do update
    data :
